            ...
            <div class="modal-dialog">   
                <div class="modal-content"> 
                    <div class="modal-header bg-warning">
                        <h4 class="text-center"><span class="fa fa-cog fa-spin fa-2x fa-fw"></span>Marcas</h4>         
                    </div>
                    <div class="modal-body">
                        <form class="form-horizontal" name="frmCategoia"  method="post" action="Grabar.php"> 
                            <div class="row">
                                ...
                                <input type="hidden" name="Mes" id="Mes"  value='M' /><br>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="modal-header btn-primary">
                    <h4 class="text-center"><span class="fa fa-cog fa-spin fa-2x fa-fw"></span>Consulta de Marcas</h4>         
                </div>

            </div>
            <br>

            <a href="Mantenimiento.php?id=0&opc=I&Mes=M" id="btnNuevo" class="btn btn-warning" title="Nuevo Registro"><i class="glyphicon glyphicon-file"></i> Nuevo Registro</a>
            <a href="../Menu.php?" id="btnsalir" class="btn btn-info" title="Salir"><i class="glyphicon glyphicon-home"></i> Menú</a>
            <br><br>
            <form name="form1" method="post" action="PagConMarcas.php" id="cdr" >
                <p>
                ...
                <div class="panel-body">
                    ...
                    <table class="table  table-hover table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $con = new Conexion();
                            $registros = $con->consultar("select id_Marca cod,descripcion_Marca des from marca where descripcion_Marca LIKE '%" . $busca . "%'");
                            ...
                            while ($reg = $registros->fetch_array()) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="Mantenimiento.php?id=<?= $id ?>&opc=M&Mes=M" rel="edit" class="btn btn-success btn-sm"> <i class="glyphicon glyphicon-edit"></i> Editar</a>
